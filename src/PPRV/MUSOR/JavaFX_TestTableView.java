...
public class JavaFX_TestTableView extends Application {
    ...
    class MyEventHandler implements EventHandler<MouseEvent> {
        ...
        public void handle(MouseEvent t) {
            ...
            try {
                idPatien = recordList.get(index).getId();
          //      new Main.InfoPatient(recordList.get(index).getId());
            //   new Main.InfoPatient(selItem.get(0).toString());
            } catch (Exception e) {
                e.printStackTrace();
            }
